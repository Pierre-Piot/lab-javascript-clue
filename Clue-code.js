...
console.log(card_stacks.characters[0]["0"].name)

function reveal(){
  var randName = parseInt(Object.keys(randChar())),
      weaponsName = parseInt(Object.keys(randWeap()));

return "the killer is in the "+ randRooms() + " his name is " + card_stacks.characters[randName][randName.toString()].name + " he killed with the weapon " +  card_stacks.weapons[weaponsName][weaponsName.toString()].name;
